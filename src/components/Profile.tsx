  ...
  return (
    <div className='flex my-4 px-4'>
        ...
        <ul >
            ...
            <li>Seoul, Korea</li>
            <li className='my-2'>
            <a className='flex items-center gap-2' href="https://github.com/hwisaac" target='_blank' rel='noreferrer'><FaGithub  size={20} className='relative top-[0.5px]' /> https://githubm.com/hwisaac</a>
